            ...
            <div className="hidden md:flex items-center gap-1">
              {NAV_LINKS.map((link) => (
                <Link
                  key={link.label}
                  href={link.href}
                  className="text-lg font-extrabold text-primary leading-snug group-hover:text-primary dark:group-hover:text-primary transition-colors line-clamp-1"
                >
                  {link.label}
                </Link>
              ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl xl:text-7xl font-extrabold text-primary tracking-tight leading-tight mb-6 text-shadow-md"
            >
              Discover Your{" "}
              <span className="relative inline-block">
                ...
                {/* underline accent */}
                <span className="absolute -bottom-1 left-0 right-0 h-[3px] rounded-full bg-primary-gradient opacity-60" />
              </span>
            </motion.h1>
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <div className="flex items-center gap-0.5 justify-end">
                      ...
                      <span className="text-sm font-bold text-primary">{college.rating}</span>
                    </div>
                  </div>
                </motion.div>
              ))}
